...
class PresenterImpl(private val context: Context, private val view: MainScreenContract.View): MainScreenContract.Presenter,
    ...
    // Permission callback functions - called from View after permission check
    ...
    override fun onBluetoothPermissionDenied() {
        // Permission denied, show message and do not connect
        view.showMessage("Bluetooth permissions required to connect")
    }
